...
const NAV: { group: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/media', label: 'Média', icon: FolderIcon },
...
function FolderIcon(p: React.SVGProps<SVGSVGElement>) {
  return <svg {...p} fill="none" stroke="currentColor" strokeWidth={1.7} viewBox="0 0 24 24"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
}
